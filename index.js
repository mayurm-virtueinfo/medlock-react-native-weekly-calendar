...
import { Text, View, ScrollView, TouchableOpacity, TouchableWithoutFeedback, Modal, Platform, ActivityIndicator, Alert } from 'react-native';
...
const WeeklyCalendar = React.forwardRef((props,ref) => {
    ...
    useImperativeHandle(ref, () => ({
        clickNextWeekHandler: clickNextWeekHandler,
        clickLastWeekHandler: clickLastWeekHandler,
        currDate:currDate,
    ...
    const clickLastWeekHandler = () => {
        ...
        setSelectedWeek(lastWeekCurrDate.clone());
        ...
        setCalendarReady(true)
        props.onChangeWeek(lastWeekCurrDate.clone().weekday(props.startWeekday - 7))
    }
    
    const clickNextWeekHandler = () => {
        setCalendarReady(false)
        const nextWeekCurrDate = currDate.add(7, 'days')
        setSelectedWeek(nextWeekCurrDate.clone());
        ...
        setCalendarReady(true)
        props.onChangeWeek(nextWeekCurrDate.clone().weekday(props.startWeekday - 7))
    }
    ...
    return (
        <View ref={ref} style={[styles.component, props.style]}>
            ...
            <View style={styles.week}>
                ...
                <View style={styles.weekdayNumberContainer}>
                    ...
                    <View style={isCalendarReady && isSelectedDate(weekdays[0]) ? [styles.weekDayNumberCircle, { backgroundColor: props.themeColor }] : (isCalendarReady && eventMap.get(weekdays[0].format('YYYY-MM-DD').toString()) !== undefined) ? [styles.weekDayNumberCircle, { backgroundColor: colors.textGrey }] : {}}>
                            <Text style={isCalendarReady && isSelectedDate(weekdays[0]) ? styles.weekDayNumberTextToday : { color: 'white' }}>
                    ...
                    <TouchableOpacity style={styles.weekDayNumber} onPress={onDayPress.bind(this, weekdays[1], 1)}>
                        <View style={isCalendarReady && isSelectedDate(weekdays[1]) ? [styles.weekDayNumberCircle, { backgroundColor: props.themeColor }] : (isCalendarReady && eventMap.get(weekdays[1].format('YYYY-MM-DD').toString()) !== undefined) ? [styles.weekDayNumberCircle, { backgroundColor: colors.textGrey }] : {}}>
                            <Text style={isCalendarReady && isSelectedDate(weekdays[1]) ? styles.weekDayNumberTextToday : { color: 'white' }}>
                    ...
                    <TouchableOpacity style={styles.weekDayNumber} onPress={onDayPress.bind(this, weekdays[2], 2)}>
                        <View style={isCalendarReady && isSelectedDate(weekdays[2]) ? [styles.weekDayNumberCircle, { backgroundColor: props.themeColor }] : (isCalendarReady && eventMap.get(weekdays[2].format('YYYY-MM-DD').toString()) !== undefined) ? [styles.weekDayNumberCircle, { backgroundColor: colors.textGrey }] : {}}>
                            <Text style={isCalendarReady && isSelectedDate(weekdays[2]) ? styles.weekDayNumberTextToday : { color: 'white' }}>
                    ...
                    <TouchableOpacity style={styles.weekDayNumber} onPress={onDayPress.bind(this, weekdays[3], 3)}>
                        <View style={isCalendarReady && isSelectedDate(weekdays[3]) ? [styles.weekDayNumberCircle, { backgroundColor: props.themeColor }] : (isCalendarReady && eventMap.get(weekdays[3].format('YYYY-MM-DD').toString()) !== undefined) ? [styles.weekDayNumberCircle, { backgroundColor: colors.textGrey }] : {}}>
                            <Text style={isCalendarReady && isSelectedDate(weekdays[3]) ? styles.weekDayNumberTextToday : { color: 'white' }}>
                    ...
                    <TouchableOpacity style={styles.weekDayNumber} onPress={onDayPress.bind(this, weekdays[4], 4)}>
                        <View style={isCalendarReady && isSelectedDate(weekdays[4]) ? [styles.weekDayNumberCircle, { backgroundColor: props.themeColor }] : (isCalendarReady && eventMap.get(weekdays[4].format('YYYY-MM-DD').toString()) !== undefined) ? [styles.weekDayNumberCircle, { backgroundColor: colors.textGrey }] : {}}>
                            <Text style={isCalendarReady && isSelectedDate(weekdays[4]) ? styles.weekDayNumberTextToday : { color: 'white' }}>
                    ...
                    <TouchableOpacity style={styles.weekDayNumber} onPress={onDayPress.bind(this, weekdays[5], 5)}>
                        <View style={isCalendarReady && isSelectedDate(weekdays[5]) ? [styles.weekDayNumberCircle, { backgroundColor: props.themeColor }] : (isCalendarReady && eventMap.get(weekdays[5].format('YYYY-MM-DD').toString()) !== undefined) ? [styles.weekDayNumberCircle, { backgroundColor: colors.textGrey }] : {}}>
                            <Text style={isCalendarReady && isSelectedDate(weekdays[5]) ? styles.weekDayNumberTextToday : { color: 'white' }}>
                    ...
                    <TouchableOpacity style={styles.weekDayNumber} onPress={onDayPress.bind(this, weekdays[6], 6)}>
                        <View style={isCalendarReady && isSelectedDate(weekdays[6]) ? [styles.weekDayNumberCircle, { backgroundColor: props.themeColor }] : (isCalendarReady && eventMap.get(weekdays[6].format('YYYY-MM-DD').toString()) !== undefined)?[styles.weekDayNumberCircle, {backgroundColor: colors.textGrey}] :{ } }>
                            <Text style={isCalendarReady && isSelectedDate(weekdays[6]) ? styles.weekDayNumberTextToday : { color: 'white' }}>
